    ...
    if request.method=='POST':
        ...
        if 'get_from_excel_button' in request.form:
            try:
                ...
                global prod_list_excel
                prod_list_excel = get_prodlist_from_excel (pr, manuf_id=2, categ_id=2)
        ...
        if 'send_to_db_button' in request.form:
            try:
                ...
                #traceback.print_exc()
                webbrowser.open('http://127.0.0.1:5222/index', new=1, autoraise=True)
...
if __name__ == "__main__":
    ...
    webbrowser.open('http://127.0.0.1:5000/index', new=0, autoraise=True)
